...
public class EncryptionOperationThread extends FileOperationThread {

    private String password;
    private int cryptoVersion;

    public EncryptionOperationThread(FileOperationService service, File inputFile, File outputFile, String password, int cryptoVersion, boolean deleteSource) {
    ...
    public void setOpTypeAndCompletionString() {
        fileOpType = FILE_OP_TYPE.ENCRYPTION_OP;
    ...
    public void run() {
        ...
        if (inputStream != null && outputStream != null) {
            ...
            try {
                ...
                //Encrypt
                aesCrypt.encrypt(cryptoVersion, inputStream, outputStream);
