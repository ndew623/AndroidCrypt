...
public class CreateFolderOperator extends FileOperator {
    public static final String CREATE_FOLDER_OPERATOR_FOLDER_NAME = "com.dewdrop623.androidcrypt.FileOperations.operator.folder.CreateFolderOperator.CREATE_FOLDER_OPERATOR_FOLDER_NAME";
