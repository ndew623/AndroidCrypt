...
public class FileMoveOperator extends FileOperator {
    public static final String FILE_MOVE_DESTINATION_ARG = "com.dewdrop623.androidcrypt.FileOperations.operator.FileMoveOperator.FILE_MOVE_DESTINATION_ARG";
    public static final String FILE_NEW_NAME_ARG = "com.dewdrop623.androidcrypt.FileOperations.operator.FileMoveOperator.FILE_NEW_NAME_ARG";
