...
public final class SettingsHelper {
    ...
    public static void setFilePickerType(Context context, int fileViewerType) {
        sharedPreferencesPutInt(context, SHARED_PREFERENCES_FILE_VIEWER_TYPE, fileViewerType);
    }
    ...
    public static int getFilePickerType(Context context) {
        return getSharedPreferencesFile(context).getInt(SHARED_PREFERENCES_FILE_VIEWER_TYPE, FILE_DEFAULT_VIEWER);
    }
}
